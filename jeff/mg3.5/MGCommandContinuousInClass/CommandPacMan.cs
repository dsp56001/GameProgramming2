...
namespace MGCommand
{
    class CommandPacMan : MonogamePacMan , ICommandComponent
    {
        ...
        private void UpdatePacLocation(GameTime gameTime)
        {
            ...
            this.Location += (
                moveOnNextUpdate * (float)(gameTime.ElapsedGameTime.TotalMilliseconds/1000) * (this.Speed)
                
                ); // Move the width of one sprite for cell based games this should be the size of the cell
        ...
        public void MoveDown()
        {
            ...
            moveOnNextUpdate = Vector2.Normalize(moveOnNextUpdate);
        }
