...
public class Player : MonoBehaviour {
	...
	void Start () {
        ...
        if (controller == null)
        {
            if (DebugText) Debug.LogWarning("GetComponent of type " + typeof(PlayerController) + " failed on " + this.name, this);
        }
    ...
    IEnumerator PowerUpTimer() //TODO move to local timer get rid of coroutine
    {
